    ...
    return {
        ...
        scrollTo: function (t, e, a, n) {
            ...
            const i = window.pageYOffset,
                ...
                d = "number" == typeof t ? t : t.offsetTop,
                c = Math.round(r - d < s ? r - s : d);
            ...
            if (0 !== t(this).length) {
                ...
                var n = {
                    ...
                    initScrollbar: function (e, n) {
                        if (t(a.tableBody).css("overflow", ""), mUtil.hasClass(e, "ps")) t(e).data("ps").update();
                        else {
...
var mLayout = function () {
    ...
    return {
        init: function () {
            this.initHeader(), this.initAside(), mUtil.get("main_portlet") && ((i = new mPortlet("main_portlet", {
                sticky: {
                    ...
                    position: {
                        ...
                        left: function () {
                            ...
                            return mUtil.isInResponsiveRange("desktop") && (t += parseInt(mUtil.css(mUtil.get("m_aside_left"), "width"))), t
                        },
                        right: function () {
            ...
            })).initSticky(), mUtil.addResizeHandler(function () {
                i && i.updateSticky()
            }))
        },
        initHeader: function () {
