...
@Injectable()
export class FactoresIntervinientesService extends CrudService<FactoresIntervinientesDto> {
    ...
    constructor(
        ...
        super(http);
        this.siniestrosUrl = environment.siniestrosUrl + '/FactoresIntervinientes';
