...
@Component({
    selector: 'createJuzgadosDtoModal',
    templateUrl: './create-juzgados-modal.component.html',

})
export class CreateJuzgadosModalComponent extends DetailEmbeddedComponent<JuzgadosDto> implements OnInit {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<CreateJuzgadosModalComponent>,
        @Inject(MAT_DIALOG_DATA) public data: any
    ) {
        super(service, injector);
        this.cfr = injector.get(ComponentFactoryResolver);
        this.detail = new JuzgadosDto();
    }
