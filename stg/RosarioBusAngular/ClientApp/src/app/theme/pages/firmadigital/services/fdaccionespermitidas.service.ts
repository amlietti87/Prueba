...
@Injectable()
export class FdAccionesPermitidasService extends CrudService<FDAccionesPermitidasDto> {
    ...
    constructor(
        ...
        super(http);
        this.firmaDigitalUrl = environment.firmaDigitalUrl + '/FdAccionesPermitidas';
