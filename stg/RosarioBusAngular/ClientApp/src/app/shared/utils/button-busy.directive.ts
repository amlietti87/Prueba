...
export class ButtonBusyDirective implements OnInit {
    ...
    refreshState(isBusy: boolean): void {
        ...
        if (isBusy) {
            ...
            if (this.ProcessHtml && this._$buttonInnerSpan.length) {
                if (!this._$buttonInnerSpan.data('_originalText')) {
                    this._$buttonInnerSpan.data('_originalText', this._$buttonInnerSpan.html());
                }

                this._$buttonInnerSpan.append(' <i class="fa fa-spinner fa-spin"></i>');
