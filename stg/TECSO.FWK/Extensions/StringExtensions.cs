...
namespace TECSO.FWK.Extensions
{
    ...
    public static class StringExtensions
    {
        ...
        public static TimeSpan? ToTimeSpan(this string str)
        {
            ...
            if (s.Length > 0)
                int.TryParse(s[0], out horas);

            if (s.Length > 1)
                int.TryParse(s[1], out min);

            if (s.Length > 2)
                int.TryParse(s[2], out sec);

            return new TimeSpan(horas, min, sec);
        }

        public static DateTime? ToTime(this string str, int defaultDay=1, int defaultMonth=1, int defaultYear=2000)
        {
            if (String.IsNullOrEmpty(str))
            {
                return null;
            ...
            return new DateTime(defaultYear,defaultMonth, defaultDay, horas, min, sec);
        }
        ...
        public static DateTime? ToDateTime(this string str)
        {
            ...
            if (!String.IsNullOrWhiteSpace(str) && DateTime.TryParse(str, out dateTime))
            {
                return dateTime;
            }
    ...
    {
        public static string ToStringDefaultFormat(this DateTime value)
        {
        ...
        public static string ToStringDefaultFormat(this DateTime? value)
        {
            if (value.HasValue)
            {
                return value.Value.ToStringDefaultFormat();
            }
            return null;
        }
    }
