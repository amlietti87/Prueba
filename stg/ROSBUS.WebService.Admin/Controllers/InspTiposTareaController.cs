...
namespace ROSBUS.WebService.Admin.Controllers
{
    ...
    public class InspTiposTareaController : ManagerSecurityController<InspTiposTarea, int, InspTiposTareaDto, InspTiposTareaFilter, IInspTiposTareaAppService>
    {
        public InspTiposTareaController(IInspTiposTareaAppService service)
            : base(service)
        {
        ...
        {
            this.InitializePermissionByDefault("Inspectores", "TiposTarea");
        }
