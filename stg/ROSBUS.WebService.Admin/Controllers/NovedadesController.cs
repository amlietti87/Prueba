...
namespace ROSBUS.WebService.Admin.Controllers
{
    ...
    public class NovedadesController : ManagerSecurityController<Novedades, int, NovedadesDto, NovedadesFilter, INovedadesAppService>
    {
        public NovedadesController(INovedadesAppService service)
            : base(service)
        {
        ...
        {
            this.InitializePermissionByDefault("Inspectores", "Novedades");
        }
