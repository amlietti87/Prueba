...
namespace ROSBUS.Operaciones.Domain.Entities
{
    public partial class Empleados : Entity<int>
    {
        public Empleados()
        {
            LegajosEmpleado = new HashSet<LegajosEmpleado>();
            UnidadNegocio = new UnidadesNegocio();
        }
        public ICollection<LegajosEmpleado> LegajosEmpleado { get; set; }
        ...
        {
            return string.Format("{0}, {1}", Apellido.Trim(), Nombre.Trim());
        }
    }
