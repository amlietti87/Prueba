...
{
    public class CategoriasRepository : RepositoryBase<AdminContext,SinCategorias, int>, ICategoriasRepository
    {
        ...
        public override Expression<Func<SinCategorias, bool>> GetFilterById(int id)
        {
            return e => e.Id == id;
        }


        public override async Task<SinCategorias> AddAsync(SinCategorias entity)
        {
            //try
            //{
